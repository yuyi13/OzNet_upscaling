...
out_path = paste0('/datasets/work/d61-af-soilmoisture/work/model_averaging/5_sm_aoa/', model_str, '/spatial_cv/')
...
foreach (k = 1:length(DOI), .packages=c('terra', 'caret', 'CAST')) %dopar% {
    ...
    if (model_str == 'rf'){
        select_model = readRDS('/datasets/work/d61-af-soilmoisture/work/model_averaging/3_model_fitting/caret/rf_model_caret_4fold_spatial_cv.rds')
        select_tdi   = readRDS('/datasets/work/d61-af-soilmoisture/work/model_averaging/3_model_fitting/caret/rf_tdi_caret_4fold_spatial_cv.rds')
    } else if (model_str == 'xgb'){
        select_model = readRDS('/datasets/work/d61-af-soilmoisture/work/model_averaging/3_model_fitting/caret/xgb_model_caret_4fold_spatial_cv.rds')
        select_tdi   = readRDS('/datasets/work/d61-af-soilmoisture/work/model_averaging/3_model_fitting/caret/xgb_tdi_caret_4fold_spatial_cv.rds')
    }
